...
class ForgotPasswordTechnician extends StatefulWidget {
  const ForgotPasswordTechnician({super.key});

  @override
  State<ForgotPasswordTechnician> createState() =>
      _ForgotPasswordTechnicianState();
}

class _ForgotPasswordTechnicianState extends State<ForgotPasswordTechnician> {

...
import 'package:reservoir_startuptn/Screens/Main_UI/UI_Components_User/Drawer_User/water_bill_user.dart';
...
class _NavBarUserState extends State<NavBarUser> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                color: Theme.of(context)
                    ...
                    .withOpacity(0.6), // Set alpha to 0 for full transparency
              ),
              child: ClipRRect(
                borderRadius: BorderRadius.circular(30),
                child: ClipPath(
      ...
      drawer: NavBarDrawer(), // Added Drawer
    );
  }
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => WaterBillUser()),
              );
            },
          ),
          Divider(

...
class NewConnectionTechnician extends StatefulWidget {
  const NewConnectionTechnician({super.key});

  @override
  State<NewConnectionTechnician> createState() => _NewConnectionTechnicianState();
}

class _NewConnectionTechnicianState extends State<NewConnectionTechnician> {
